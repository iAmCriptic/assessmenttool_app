...
class _MyEvaluationsPageState extends State<MyEvaluationsPage> {
  ...
  Future<void> _loadSessionCookie() async {
    ...
    print('DEBUG (Flutter): MyEvaluationsPage - Session cookie loaded: $_sessionCookie');
  }
  ...
  Future<void> _loadUserRole() async {
    ...
    setState(() {
      ...
      print('DEBUG (Flutter): MyEvaluationsPage - User role loaded: $_userRole');
    });
  }
  ...
  Future<void> _fetchMyEvaluationsData() async {
  ...
  Widget build(BuildContext context) {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 20),
                ElevatedButton(
                  onPressed: _fetchMyEvaluationsData,
    ...
    return Scaffold(
      body: RefreshIndicator(
        onRefresh: _fetchMyEvaluationsData,
